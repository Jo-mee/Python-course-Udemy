...
isAutomaticMode = True # True oznacza, że kierowca ustawił pokrętło sterujące światłem na tryb automatyczny
...
isDirectLight - True # True oznacza, że nisko położone słońce świeci wprost w oczy kierowcy.
